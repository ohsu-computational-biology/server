...
class PhenotypeAssociationSet(AbstractPhenotypeAssociationSet):
    ...
    def getAssociations(self, request=None, pageSize=None, offset=0,
        ...
        # print(associations_details) TODO cleanup
...
"""
        ...
        if issubclass(request.__class__,
                      protocol.SearchFeaturesRequest):
            filters += self._filterSearchFeaturesRequest(request)
    ...
    def _filterSearchFeaturesRequest(self, request):
